  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> addReveiw2UsersRecordList = snapshot.data!;
        // Return an empty Container when the document does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final addReveiw2UsersRecord = addReveiw2UsersRecordList.isNotEmpty
            ? addReveiw2UsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
