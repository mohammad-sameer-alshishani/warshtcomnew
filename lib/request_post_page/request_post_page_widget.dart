...
class RequestPostPageWidget extends StatefulWidget {
  const RequestPostPageWidget({
    Key? key,
    this.requestpostId,
  }) : super(key: key);
  ...
  @override
  _RequestPostPageWidgetState createState() => _RequestPostPageWidgetState();
}

class _RequestPostPageWidgetState extends State<RequestPostPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: StreamBuilder<List<RequestPostRecord>>(
          stream: queryRequestPostRecord(
            queryBuilder: (requestPostRecord) => requestPostRecord.where(
                'post_ID',
                isEqualTo:
                    widget.requestpostId != '' ? widget.requestpostId : null),
            singleRecord: true,
          ),
          builder: (context, snapshot) {
            ...
            List<RequestPostRecord> stackRequestPostRecordList = snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final stackRequestPostRecord = stackRequestPostRecordList.isNotEmpty
                ? stackRequestPostRecordList.first
                : null;
            return Stack(
              children: [
                StreamBuilder<UsersRecord>(
                  stream: UsersRecord.getDocument(
                      stackRequestPostRecord!.postUser!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                          ...
                          stream: queryCommentsRecord(
                            queryBuilder: (commentsRecord) =>
                                commentsRecord.where('commented_post_id',
                                    isEqualTo: widget.requestpostId != ''
                                        ? widget.requestpostId
                                        : null),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SelectionArea(
                                        child: Text(
                                      stackRequestPostRecord!.postTitle!,
                                                        ...
                                                        if (stackRequestPostRecord!
                                                          ...
                                                          Align(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Visibility(
                                                                visible: stackRequestPostRecord!
                                                                        .postPhoto!
                                                                        .toList()
                                                                        .length !=
                                                                    null,
                                                                child: StreamBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final listViewPostsRecord = listViewPostsRecordList
                                                                            .isNotEmpty
                                                                        ? listViewPostsRecordList
                                                                            .first
                                                                        : null;
                                                                    return Builder(
                                                                      builder:
                                                                          (context) {
                                                                        final requestPostPhotos = stackRequestPostRecord!
                                                                            .postPhoto!
                                                                            .toList();
                                                                        return ListView
                                                                            .builder(
                                                                          ...
                                                                          scrollDirection:
                                                                              Axis.horizontal,
                                                                          itemCount:
                                                                              requestPostPhotos.length,
                                                                          itemBuilder:
                                                                              (context, requestPostPhotosIndex) {
                                                                            final requestPostPhotosItem =
                                                                                requestPostPhotos[requestPostPhotosIndex];
                                                                            return StreamBuilder<List<PostsRecord>>(
                                                                              stream: queryPostsRecord(
                                                                                queryBuilder: (postsRecord) => postsRecord.where('post_ID', isEqualTo: widget.requestpostId != '' ? widget.requestpostId : null),
                                                                                singleRecord: true,
                                                                              ),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
                                                                                ...
                                                                                final containerPostsRecord = containerPostsRecordList.isNotEmpty ? containerPostsRecordList.first : null;
                                                                                return Container(
                                                                  ...
                                                                  children: [
                                                                    ToggleIcon(
                                                                      onPressed:
                                                                        ...
                                                                        final likedByUpdate = stackRequestPostRecord!.likedBy!.toList().contains(likedByElement)
                                                                        ...
                                                                        await stackRequestPostRecord!
                                                                            .reference
                                                                            .update(requestPostUpdateData);
                                                                      },
                                                                      value: stackRequestPostRecord!
                                                                          .likedBy!
                                                                          .toList()
                                                                          .contains(
                                                                              currentUserReference),
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (stackRequestPostRecord!
                                                                          ...
                                                                          final usersUpdateData =
                                                                            ...
                                                                            'liked_request_posts':
                                                                                FieldValue.arrayRemove([
                                                                              stackRequestPostRecord!.reference
                                                                            ]),
                                                                          };
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            UsersRecord>(
                                                                          stream:
                                                                              UsersRecord.getDocument(listViewCommentsRecord.commentedByRef!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                                ...
                                                                                child: FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    final commentsCreateData = createCommentsRecordData(
                                                                                      ...
                                                                                      commentedPostUserRef: stackRequestPostRecord!.postUser,
                                                                                      commentedByUserPhoto: currentUserPhoto,
                                                                                      commentedPostId: stackRequestPostRecord!.postID,
                                                                                      commentedRequestPost: stackRequestPostRecord!.reference,
