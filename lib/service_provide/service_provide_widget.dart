...
class ServiceProvideWidget extends StatefulWidget {
  const ServiceProvideWidget({Key? key}) : super(key: key);

  @override
  _ServiceProvideWidgetState createState() => _ServiceProvideWidgetState();
}

class _ServiceProvideWidgetState extends State<ServiceProvideWidget>
  ...
  void initState() {
    ...
    forEveryController = TextEditingController();
    postPriceCustomizeController = TextEditingController();
    workTypeCustomizeController = TextEditingController();
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          if (FFAppState().customizeTriger) {
                                              ...
                                              ...createRequestPostRecordData(
                                                ...
                                                postType:
                                                    workTypeCustomizeController!
                                                        .text,
                                                priceType:
                                                    forEveryController!.text,
                                                postUserLocation: dropDownValue,
                                            ...
                                            await RequestPostRecord.collection
                                                .doc()
                                                .set(requestPostCreateData);
