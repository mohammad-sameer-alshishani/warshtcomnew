...
class AppStateNotifier extends ChangeNotifier {
  WarshtcomnewFirebaseUser? initialUser;
  WarshtcomnewFirebaseUser? user;
  ...
  void update(WarshtcomnewFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ...
                  : HomePageWidget(
                      authenticatedUserRecieveDoc: params.getParam(
