...
/// Functions to query ReveiwsRecords (as a Stream and as a Future).
Stream<List<ReveiwsRecord>> queryReveiwsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ReveiwsRecord>> queryReveiwsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ReveiwsRecord>> queryReveiwsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
