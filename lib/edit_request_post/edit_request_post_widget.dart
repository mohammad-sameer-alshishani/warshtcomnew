...
class EditRequestPostWidget extends StatefulWidget {
  const EditRequestPostWidget({
    Key? key,
    this.editRequestPost,
  }) : super(key: key);

  final DocumentReference? editRequestPost;

  @override
  _EditRequestPostWidgetState createState() => _EditRequestPostWidgetState();
}

class _EditRequestPostWidgetState extends State<EditRequestPostWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RequestPostRecord>(
      stream: RequestPostRecord.getDocument(widget.editRequestPost!),
      builder: (context, snapshot) {
        ...
        final editRequestPostRequestPostRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                                          ...
                                          return FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              if (FFAppState()
                                                ...
                                                await editRequestPostRequestPostRecord
                                                    .reference
                                                    .update(
                                                        requestPostUpdateData);
                                      ...
                                      Expanded(
                                        child: TextFormField(
                                          controller: postTitleController ??=
                                            ...
                                            text:
                                                editRequestPostRequestPostRecord
                                                    .postTitle,
                                          ),
                                          autofocus: true,
                                          obscureText: false,
                              ...
                              child: AuthUserStreamWidget(
                                child: TextFormField(
                                  controller: postDescriptionController ??=
                                      TextEditingController(
                                    text: editRequestPostRequestPostRecord
                                        .postDescription,
                                  ),
                                  autofocus: true,
                                  obscureText: false,
